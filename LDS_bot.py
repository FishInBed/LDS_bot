...
import re
try:
    from intent import Loki_B_siblings
    from intent import Loki_B_carer
    from intent import Loki_B_school
    from intent import Loki_B_3c
    ...
    if lokiRst.getStatus():
        for index, key in enumerate(inputLIST):
            ...
            for resultIndex in range(0, lokiRst.getLokiLen(index)):
                # B_siblings
                if lokiRst.getIntent(index, resultIndex) == "B_siblings":
                    lokiResultDICT = Loki_B_siblings.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)

                # B_carer
                if lokiRst.getIntent(index, resultIndex) == "B_carer":
                    lokiResultDICT = Loki_B_carer.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)

                # B_school
                if lokiRst.getIntent(index, resultIndex) == "B_school":
                    lokiResultDICT = Loki_B_school.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)

                # B_3c
                if lokiRst.getIntent(index, resultIndex) == "B_3c":
                    lokiResultDICT = Loki_B_3c.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)
                ...
                if lokiRst.getIntent(index, resultIndex) == "weight":
                    lokiResultDICT = Loki_weight.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)

                # congenital_disease
                if lokiRst.getIntent(index, resultIndex) == "congenital_disease":
                    lokiResultDICT = Loki_congenital_disease.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)
                ...
                if lokiRst.getIntent(index, resultIndex) == "hospitalized":
                    lokiResultDICT = Loki_hospitalized.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)
...
def testIntent():
    # B_siblings
    print("[TEST] B_siblings")
    inputLIST = ['有','沒有','有1個哥哥','哥哥姐姐各1個','1個哥哥1個姐姐','哥哥跟姐姐各1個','有1個哥哥跟1個姐姐','1個哥哥1個姐姐1個弟弟','1個哥哥1個姐姐跟1個弟弟','1個哥哥1個姐姐1個妹妹1個弟弟','1個哥哥1個姐姐1個妹妹跟1個弟弟']
    testLoki(inputLIST, ['B_siblings'])
    print("")

    # B_carer
    print("[TEST] B_carer")
    inputLIST = ['保母','媽媽']
    testLoki(inputLIST, ['B_carer'])
    print("")

    # B_school
    print("[TEST] B_school")
    inputLIST = ['沒有','幼兒園']
    testLoki(inputLIST, ['B_school'])
    print("")

    # B_3c
    print("[TEST] B_3c")
    inputLIST = ['否','對','是','有','不是','沒有']
    testLoki(inputLIST, ['B_3c'])
    print("")

    # gender
    print("[TEST] gender")
    inputLIST = ['兒子','女兒','女生','女的','男生','男的','女孩子','男孩子']
    testLoki(inputLIST, ['gender'])
    print("")

    # age
    print("[TEST] age")
    inputLIST = ['他1歲','他2個月大','他1歲2個月']
    testLoki(inputLIST, ['age'])
    print("")

    # ten_month
    print("[TEST] ten_month")
    inputLIST = ['有','早產','沒有','是早產','有足月','不是早產','是早產兒','沒有足月','不是早產兒']
    testLoki(inputLIST, ['ten_month'])
    print("")
    ...
    # congenital_disease
    print("[TEST] congenital_disease")
    inputLIST = ['唇顎裂']
    testLoki(inputLIST, ['congenital_disease'])
    print("")

    # genetic_disease
    print("[TEST] genetic_disease")
    inputLIST = ['自閉']
    testLoki(inputLIST, ['genetic_disease'])
    print("")

    # hospitalized
    print("[TEST] hospitalized")
    inputLIST = ['有','沒有','曾經住過院','曾經住院過','因為黃疸住過院','因為黃疸住院過']
    testLoki(inputLIST, ['hospitalized'])
    print("")
