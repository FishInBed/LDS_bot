...
try:
    ...
    LOKI_KEY = accountInfo["loki_key_environment"]
        ...
        for index, key in enumerate(inputLIST):
            ...
            for resultIndex in range(0, lokiRst.getLokiLen(index)):
                ...
                if lokiRst.getIntent(index, resultIndex) == "school":
                    lokiResultDICT = Loki_school.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)

                # 3C
                if lokiRst.getIntent(index, resultIndex) == "3C":
                    lokiResultDICT = Loki_3C.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), lokiResultDICT, refDICT)
...
def testIntent():
    ...
    # 3C
    print("[TEST] 3C")
    inputLIST = ['一天大概30分鐘','每天用平板大概30分鐘','每天大概使用平板電腦30分鐘。']
    testLoki(inputLIST, ['3C'])
    print("")
